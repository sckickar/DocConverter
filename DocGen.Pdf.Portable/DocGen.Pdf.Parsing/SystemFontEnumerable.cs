...
internal static class SystemFontEnumerable
{
	...
	public static TSource[] ToArray<TSource>(IEnumerable<TSource> source)
	{
		...
		return new SystemFontBuffer<TSource>(source).ToArray();
	}
	...
	public static ISystemFontOrderedEnumerable<TSource> OrderBy<TSource, TKey>(IEnumerable<TSource> source, Func<TSource, TKey> keySelector)
	{
		return new OrderedEnumerable<TSource, TKey>(source, keySelector, null, descending: false);
	}

	public static ISystemFontOrderedEnumerable<TSource> OrderBy<TSource, TKey>(IEnumerable<TSource> source, Func<TSource, TKey> keySelector, IComparer<TKey> comparer)
	{
