...
internal class Separation : Colorspace
{
	...
	private double[] ToDouble(string[] pars)
	{
	...
	{
		return AlternateColorspace.GetColor(AlternateColorspace.ToParams(Function.ColorTransferFunction(new double[1] { (int)bytes[offset] })));
	}
