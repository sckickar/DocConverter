...
internal class SystemFontHFlex : SystemFontOperator
{
	public override void Execute(SystemFontBuildChar buildChar)
	{
		...
		SystemFontOperator.CurveTo(buildChar, firstAsInt, 0, firstAsInt2, firstAsInt3, firstAsInt4, 0);
		SystemFontOperator.CurveTo(buildChar, firstAsInt5, 0, firstAsInt6, 0, firstAsInt7, 0);
	}
}
