...
internal static class SystemFontAdobeGlyphList
{
	...
	static SystemFontAdobeGlyphList()
	{
		Initialize();
	}
	...
	public static char GetUnicode(string names)
	{
		...
		string[] array = names.Split(new char[1] { '_' });
		if (array.Length != 0)
		{
	...
	private static char GetUnicodeForName(string name)
	{
		...
		if (name.StartsWith("uni"))
		{
			...
			{
				return ParseHex(name.Substring(num, 4));
			}
			return '\0';
		}
		if (name.StartsWith("u"))
		{
			return ParseHex(name.Substring(1, name.Length - 1));
		}
