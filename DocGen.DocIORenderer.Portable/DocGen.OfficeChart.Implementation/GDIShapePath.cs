...
internal class GDIShapePath
{
	private RectangleF _rectBounds;

	private Dictionary<string, string> _shapeGuide;

	internal GDIShapePath(RectangleF bounds, Dictionary<string, string> shapeGuide)
	{
		_rectBounds = bounds;
	...
	internal GraphicsPath GetGDICurvedConnectorPath()
	{
		Dictionary<string, float> dictionary = ParseShapeFormula(AutoShapeType.CurvedConnector);
		GraphicsPath graphicsPath = new GraphicsPath();
		graphicsPath.AddBeziers(new PointF[7]
	...
	internal GraphicsPath GetGDIBentConnectorPath()
	{
		Dictionary<string, float> dictionary = ParseShapeFormula(AutoShapeType.ElbowConnector);
		PointF[] linePoints = new PointF[4]
		{
	...
	internal GraphicsPath GetGDIBentConnector2Path()
	{
		PointF[] linePoints = new PointF[3]
		{
			new PointF(_rectBounds.X, _rectBounds.Y),
	...
	internal GraphicsPath GetGDIBentConnector4Path()
	{
		Dictionary<string, float> dictionary = ParseShapeFormula(AutoShapeType.BentConnector4);
		PointF[] linePoints = new PointF[5]
		{
	...
	internal GraphicsPath GetGDIBentConnector5Path()
	{
		Dictionary<string, float> dictionary = ParseShapeFormula(AutoShapeType.BentConnector5);
		PointF[] linePoints = new PointF[6]
		{
	...
	internal GraphicsPath GetGDICurvedConnector2Path()
	{
		GraphicsPath graphicsPath = new GraphicsPath();
	...
	internal GraphicsPath GetGDICurvedConnector4Path()
	{
	...
	internal GraphicsPath GetGDICurvedConnector5Path()
	{
	...
	internal GraphicsPath GetCubePath()
	{
		...
		graphicsPath.AddLines(array);
		graphicsPath.CloseFigure();
		PointF pointF = new PointF(_rectBounds.X + dictionary["x4"], _rectBounds.Y + dictionary["y1"]);
		graphicsPath.AddLine(array[0], pointF);
		graphicsPath.AddLine(array[2], pointF);
		graphicsPath.AddLine(array[4], pointF);
		return graphicsPath;
	}
	...
	internal GraphicsPath[] GetSmileyFacePath(bool isDrawEye)
	{
		...
		array[0].AddEllipse(_rectBounds.X + dictionary["x2"], _rectBounds.Y + dictionary["y1"] - dictionary["hR"], dictionary["wR"] * 2f, dictionary["hR"] * 2f);
		array[0].AddEllipse(_rectBounds.X + dictionary["x3"], _rectBounds.Y + dictionary["y1"] - dictionary["hR"], dictionary["wR"] * 2f, dictionary["hR"] * 2f);
		return array;
	}
	...
	{
		ParseShapeFormula(AutoShapeType.LightningBolt);
		GraphicsPath graphicsPath = new GraphicsPath();
	...
	{
		ParseShapeFormula(AutoShapeType.FlowChartAlternateProcess);
		GraphicsPath graphicsPath = new GraphicsPath();
	...
	{
		GraphicsPath graphicsPath = new GraphicsPath();
		ParseShapeFormula(AutoShapeType.FlowChartOr);
	...
	{
		ParseShapeFormula(AutoShapeType.Explosion1);
		GraphicsPath graphicsPath = new GraphicsPath();
		graphicsPath.AddLines(new PointF[24]
		{
	...
	{
		ParseShapeFormula(AutoShapeType.Explosion2);
		GraphicsPath graphicsPath = new GraphicsPath();
	...
	internal GraphicsPath[] GetHorizontalScroll()
	{
		...
		GraphicsPath[] array = new GraphicsPath[7];
		for (int i = 0; i < array.Length; i++)
		{
			array[i] = new GraphicsPath();
		}
	...
	internal GraphicsPath GetLineCallout1Path()
	{
		...
		GraphicsPath graphicsPath = new GraphicsPath();
		float num = ((!(dictionary["x1"] < dictionary["x2"])) ? ((dictionary["x2"] < 0f) ? dictionary["x2"] : 0f) : ((dictionary["x1"] < 0f) ? dictionary["x1"] : 0f));
		RectangleF rectangleF = _rectBounds;
		if (num < 0f)
		{
			rectangleF = new RectangleF(_rectBounds.X - num, _rectBounds.Y, _rectBounds.Width, _rectBounds.Height);
		}
		graphicsPath.AddLines(new PointF[4]
		{
		...
		PointF[] array = new PointF[2]
		{
			new PointF(rectangleF.X + dictionary["x1"], rectangleF.Y + dictionary["y1"]),
			new PointF(rectangleF.X + dictionary["x2"], rectangleF.Y + dictionary["y2"])
		};
		graphicsPath.AddLine(array[0], array[1]);
		graphicsPath.CloseFigure();
		return graphicsPath;
	...
	{
		ParseShapeFormula(AutoShapeType.LineCallout2NoBorder);
		GraphicsPath graphicsPath = new GraphicsPath();
	...
	{
		ParseShapeFormula(AutoShapeType.LineCallout3NoBorder);
		GraphicsPath graphicsPath = new GraphicsPath();
		PointF[] linePoints = new PointF[2];
		graphicsPath.AddLines(linePoints);
		graphicsPath.CloseFigure();
	...
	{
		ParseShapeFormula(AutoShapeType.LineCallout1BorderAndAccentBar);
		GraphicsPath graphicsPath = new GraphicsPath();
		PointF[] linePoints = new PointF[2];
		graphicsPath.AddLines(linePoints);
		graphicsPath.CloseFigure();
	...
	{
		ParseShapeFormula(AutoShapeType.LineCallout2BorderAndAccentBar);
		GraphicsPath graphicsPath = new GraphicsPath();
		PointF[] linePoints = new PointF[2];
		graphicsPath.AddLines(linePoints);
		graphicsPath.CloseFigure();
	...
	{
		ParseShapeFormula(AutoShapeType.LineCallout3BorderAndAccentBar);
		GraphicsPath graphicsPath = new GraphicsPath();
		PointF[] linePoints = new PointF[2];
		graphicsPath.AddLines(linePoints);
		graphicsPath.CloseFigure();
