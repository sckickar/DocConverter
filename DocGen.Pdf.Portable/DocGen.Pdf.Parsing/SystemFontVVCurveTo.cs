...
internal class SystemFontVVCurveTo : SystemFontOperator
{
	public override void Execute(SystemFontBuildChar interpreter)
	{
		...
		SystemFontOperator.CurveTo(interpreter, dxa, firstAsInt, firstAsInt2, firstAsInt3, 0, firstAsInt4);
		while (operands.Count / 4 > 0)
		{
			...
			SystemFontOperator.CurveTo(interpreter, 0, firstAsInt, firstAsInt2, firstAsInt3, 0, firstAsInt4);
		}
		operands.Clear();
	}
}
