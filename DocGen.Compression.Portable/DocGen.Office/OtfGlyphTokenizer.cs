...
internal class OtfGlyphTokenizer
{
	...
	internal float GetLineWidth(OtfGlyphInfo[] glyphs, TrueTypeFont font, TrueTypeFontStringFormat format)
	{
		float num = 0f;
	...
	internal float GetLineWidth(OtfGlyphInfo[] glyphs, TrueTypeFont font, TrueTypeFontStringFormat format, string text, out float outWordSpace, out float outCharSpace)
	{
		float num = 0f;
		outWordSpace = 0f;
		outCharSpace = 0f;
	...
	protected float ApplyFormatSettings(OtfGlyphInfo[] glyphs, TrueTypeFontStringFormat format, float width, string text, out float outWordSpace, out float outCharSpace)
	{
		outWordSpace = 0f;
		outCharSpace = 0f;
	...
	protected float ApplyFormatSettings(OtfGlyphInfo[] glyphs, TrueTypeFontStringFormat format, float width)
	{
		float num = width;
		if (format != null && width > 0f)
		{
