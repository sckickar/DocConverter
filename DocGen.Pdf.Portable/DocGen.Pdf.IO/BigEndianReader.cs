...
internal class BigEndianReader
{
	...
	private readonly Encoding c_encoding = Encoding.GetEncoding("latin1");
	...
	public int Read(byte[] buffer, int index, int count)
	{
		...
		do
		{
			...
			if ((RuntimeInformation.IsOSPlatform(OSPlatform.Linux) && num2 == 0) || (RuntimeInformation.IsOSPlatform(OSPlatform.OSX) && num2 == 0) || (num2 == 0 && m_reader.BaseStream.Position >= m_reader.BaseStream.Length))
			{
				break;
			}
			num += num2;
