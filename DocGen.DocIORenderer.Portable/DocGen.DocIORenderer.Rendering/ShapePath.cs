...
namespace DocGen.DocIORenderer.Rendering;
...
internal class ShapePath
{
	...
	internal PdfPath GetCurvedConnectorPath()
	{
		...
		pdfPath.AddBeziers(new PointF[7]
		{
	...
	{
		PdfPath pdfPath = new PdfPath();
		pdfPath.AddBeziers(new PointF[4]
		{
			new PointF(_rectBounds.X, _rectBounds.Y),
	...
	internal PdfPath GetCurvedConnector4Path()
	{
		...
		pdfPath.AddBeziers(new PointF[10]
		{
			new PointF(_rectBounds.X, _rectBounds.Y),
			new PointF(_rectBounds.X + dictionary["x1"], _rectBounds.Y),
	...
	internal PdfPath GetCurvedConnector5Path()
	{
		...
		pdfPath.AddBeziers(new PointF[13]
		{
			new PointF(_rectBounds.X, _rectBounds.Y),
	...
	internal PdfPath GetBentConnectorPath()
	{
		...
		PdfPath pdfPath = new PdfPath();
		pdfPath.StartFigure();
		pdfPath.AddLine(array[0], array[1]);
		pdfPath.CloseFigure();
		pdfPath.StartFigure();
		pdfPath.AddLine(array[1], array[2]);
		pdfPath.CloseFigure();
		pdfPath.StartFigure();
		pdfPath.AddLine(array[2], array[3]);
		pdfPath.CloseFigure();
		return pdfPath;
	}
	...
	internal PdfPath GetRoundedRectanglePath()
	{
		...
		if (num > 0f)
		{
			pdfPath.AddArc(_rectBounds.X, _rectBounds.Y, num, num, 180f, 90f);
			pdfPath.AddArc(_rectBounds.Right - num, _rectBounds.Y, num, num, 270f, 90f);
			pdfPath.AddArc(_rectBounds.Right - num, _rectBounds.Bottom - num, num, num, 0f, 90f);
			pdfPath.AddArc(_rectBounds.X, _rectBounds.Bottom - num, num, num, 90f, 90f);
			pdfPath.CloseFigure();
		}
		return pdfPath;
	}
	...
	internal PdfPath GetRoundSameSideCornerRectanglePath()
	{
		...
		{
			pdfPath.AddArc(_rectBounds.Right - num2, _rectBounds.Bottom - num2, num2, num2, 0f, 90f);
			pdfPath.AddArc(_rectBounds.X, _rectBounds.Bottom - num2, num2, num2, 90f, 90f);
		}
		pdfPath.AddArc(_rectBounds.X, _rectBounds.Y, num, num, 180f, 90f);
		pdfPath.CloseFigure();
		return pdfPath;
	...
	internal PdfPath GetRoundDiagonalCornerRectanglePath()
	{
		...
		if (num2 != 0f)
		{
			pdfPath.AddArc(_rectBounds.Right - num2, _rectBounds.Y, num2, num2, 270f, 90f);
		}
		pdfPath.AddArc(_rectBounds.Right - num, _rectBounds.Bottom - num, num, num, 0f, 90f);
		if (num2 == 0f)
		{
	...
	internal PdfPath GetDecagonPath()
	{
		...
		PdfPath pdfPath = new PdfPath();
		pdfPath.AddLines(new PointF[10]
		{
			new PointF(_rectBounds.X, _rectBounds.Y + _rectBounds.Height / 2f),
			new PointF(_rectBounds.X + dictionary["x1"], _rectBounds.Y + dictionary["y2"]),
			new PointF(_rectBounds.X + dictionary["x2"], _rectBounds.Y + dictionary["y1"]),
	...
	internal PdfPath GetDodecagonPath()
	{
		...
		PdfPath pdfPath = new PdfPath();
		pdfPath.AddLines(new PointF[12]
		{
			new PointF(_rectBounds.X, _rectBounds.Y + dictionary["y2"]),
			new PointF(_rectBounds.X + dictionary["x1"], _rectBounds.Y + dictionary["y1"]),
			new PointF(_rectBounds.X + dictionary["x2"], _rectBounds.Y),
	...
	internal PdfPath GetPiePath()
	{
		...
		PdfPath pdfPath = new PdfPath();
		pdfPath.AddPie(_rectBounds.X, _rectBounds.Y, _rectBounds.Width, _rectBounds.Height, dictionary["stAng"], dictionary["swAng"]);
		return pdfPath;
	}
	...
	internal PdfPath GetChordPath()
	{
		...
		PdfPath pdfPath = new PdfPath();
		pdfPath.AddArc(_rectBounds.X, _rectBounds.Y, _rectBounds.Width, _rectBounds.Height, dictionary["stAng"], dictionary["swAng"]);
		pdfPath.CloseFigure();
		return pdfPath;
	}
	...
	internal PdfPath GetTearDropPath()
	{
		...
		PdfPath pdfPath = new PdfPath();
		pdfPath.AddArc(_rectBounds.X, _rectBounds.Y, _rectBounds.Width, _rectBounds.Height, 180f, 90f);
		pdfPath.AddBeziers(new PointF[7]
		{
			new PointF(_rectBounds.X + dictionary["x2"], _rectBounds.Y),
			new PointF(_rectBounds.X + dictionary["x2"], _rectBounds.Y),
		...
		pdfPath.AddArc(_rectBounds.X, _rectBounds.Y, _rectBounds.Width, _rectBounds.Height, 0f, 90f);
		pdfPath.AddArc(_rectBounds.X, _rectBounds.Y, _rectBounds.Width, _rectBounds.Height, 90f, 90f);
		pdfPath.CloseFigure();
		return pdfPath;
	}
	...
	internal PdfPath GetPlaquePath()
	{
		...
		PdfPath pdfPath = new PdfPath();
		float num = dictionary["x1"] * 2f;
		pdfPath.AddArc(_rectBounds.X - dictionary["x1"], _rectBounds.Y - dictionary["x1"], num, num, 90f, -90f);
		pdfPath.AddArc(_rectBounds.Right - dictionary["x1"], _rectBounds.Y - dictionary["x1"], num, num, 180f, -90f);
		pdfPath.AddArc(_rectBounds.Right - dictionary["x1"], _rectBounds.Bottom - dictionary["x1"], num, num, 270f, -90f);
		pdfPath.AddArc(_rectBounds.X - dictionary["x1"], _rectBounds.Bottom - dictionary["x1"], num, num, 0f, -90f);
		pdfPath.CloseFigure();
		return pdfPath;
	}
	...
	internal PdfPath GetCanPath()
	{
		...
		PdfPath pdfPath = new PdfPath();
		pdfPath.AddArc(_rectBounds.X, _rectBounds.Y, _rectBounds.Width, dictionary["y1"] * 2f, 0f, 180f);
		pdfPath.AddArc(_rectBounds.X, _rectBounds.Y, _rectBounds.Width, dictionary["y1"] * 2f, 180f, 180f);
		pdfPath.AddArc(_rectBounds.X, _rectBounds.Y + dictionary["y3"] - dictionary["y1"], _rectBounds.Width, dictionary["y1"] * 2f, 0f, 180f);
		pdfPath.AddLine(_rectBounds.X, _rectBounds.Y + dictionary["y3"] - dictionary["y1"], _rectBounds.X, _rectBounds.Y + dictionary["y1"]);
		return pdfPath;
	}
	...
	internal PdfPath GetBevelPath()
	{
		...
		pdfPath.CloseFigure();
		pdfPath.AddLine(_rectBounds.X, _rectBounds.Y, _rectBounds.X + dictionary["x1"], _rectBounds.Y + dictionary["x1"]);
		pdfPath.CloseFigure();
		pdfPath.AddLine(_rectBounds.X, _rectBounds.Bottom, _rectBounds.X + dictionary["x1"], _rectBounds.Y + dictionary["y2"]);
		pdfPath.CloseFigure();
		pdfPath.AddLine(_rectBounds.Right, _rectBounds.Y, _rectBounds.X + dictionary["x2"], _rectBounds.Y + dictionary["x1"]);
		pdfPath.CloseFigure();
		pdfPath.AddLine(_rectBounds.Right, _rectBounds.Bottom, _rectBounds.X + dictionary["x2"], _rectBounds.Y + dictionary["y2"]);
		pdfPath.CloseFigure();
		return pdfPath;
	}
	...
	internal PdfPath GetDonutPath()
	{
		...
		PdfPath pdfPath = new PdfPath();
		RectangleF rectangle = new RectangleF(_rectBounds.X, _rectBounds.Y, _rectBounds.Width, _rectBounds.Height);
		if (rectangle.Width > 0f && rectangle.Height > 0f)
		{
			pdfPath.AddArc(rectangle, 180f, 90f);
			pdfPath.AddArc(rectangle, 270f, 90f);
			pdfPath.AddArc(rectangle, 0f, 90f);
			pdfPath.AddArc(rectangle, 90f, 90f);
		}
		pdfPath.CloseFigure();
		rectangle = new RectangleF(_rectBounds.X + dictionary["dr"], _rectBounds.Y + dictionary["dr"], dictionary["iwd2"] * 2f, dictionary["ihd2"] * 2f);
		if (rectangle.Width > 0f && rectangle.Height > 0f)
		{
			pdfPath.AddArc(rectangle, 180f, -90f);
			pdfPath.AddArc(rectangle, 90f, -90f);
	...
	internal PdfPath GetNoSymbolPath()
	{
		...
		pdfPath.CloseFigure();
		pdfPath.AddArc(_rectBounds.X + dictionary["dr"], _rectBounds.Y + dictionary["dr"], dictionary["iwd2"] * 2f, dictionary["ihd2"] * 2f, dictionary["stAng1"], dictionary["swAng"]);
		pdfPath.CloseFigure();
		pdfPath.AddArc(_rectBounds.X + dictionary["dr"], _rectBounds.Y + dictionary["dr"], dictionary["iwd2"] * 2f, dictionary["ihd2"] * 2f, dictionary["stAng2"], dictionary["swAng"]);
		pdfPath.CloseFigure();
		return pdfPath;
	}
	...
	internal PdfPath GetBlockArcPath()
	{
		...
		pdfPath.AddArc(rectangle, dictionary["stAng"] / 60000f, dictionary["swAng"] / 60000f);
		pdfPath.AddArc(_rectBounds.Right - dictionary["x2"], _rectBounds.Bottom - dictionary["y2"], dictionary["iwd2"] * 2f, dictionary["ihd2"] * 2f, dictionary["istAng"] / 60000f, dictionary["iswAng"] / 60000f);
		pdfPath.CloseFigure();
		return pdfPath;
	}
	...
	{
		PdfPath pdfPath = new PdfPath();
		pdfPath.AddLines(new PointF[11]
		{
	...
	internal PdfPath GetSunPath()
	{
		...
		pdfPath.AddLines(array);
		pdfPath.CloseFigure();
		pdfPath.AddEllipse(_rectBounds.X + dictionary["x19"], _rectBounds.Y + _rectBounds.Height / 2f - dictionary["hR"], dictionary["wR"] * 2f, dictionary["hR"] * 2f);
		pdfPath.CloseFigure();
		return pdfPath;
	}
	...
	internal PdfPath GetMoonPath()
	{
		...
		PdfPath pdfPath = new PdfPath();
		pdfPath.AddArc(_rectBounds.X, _rectBounds.Y, _rectBounds.Width * 2f, _rectBounds.Height, 90f, 180f);
		float num = dictionary["stAng1"];
		if (num < 180f)
		{
			num += 180f;
		}
		pdfPath.AddArc(_rectBounds.X + dictionary["g0w"], _rectBounds.Y + _rectBounds.Height / 2f - dictionary["dy1"], dictionary["g18w"] * 2f, dictionary["dy1"] * 2f, num, dictionary["swAng1"] % 360f);
		pdfPath.CloseFigure();
		return pdfPath;
	}
	...
	internal PdfPath GetCloudPath()
	{
		...
		pdfPath.AddArc(_rectBounds.X + 4076f * _rectBounds.Width / 43200f, _rectBounds.Y + 3912f * _rectBounds.Height / 43200f, sizeF.Width, sizeF.Height, -190f, 123f);
		pdfPath.AddArc(_rectBounds.X + 13469f * _rectBounds.Width / 43200f, _rectBounds.Y + 1304f * _rectBounds.Height / 43200f, sizeF2.Width, sizeF2.Height, -144f, 89f);
		pdfPath.AddArc(_rectBounds.X + _rectBounds.Width / 2f + 531f * _rectBounds.Width / 43200f, _rectBounds.Y + 1f, sizeF3.Width, sizeF3.Height, -145f, 99f);
		pdfPath.AddArc(xYPosition.X + _rectBounds.Width / 2f + 3013f * _rectBounds.Width / 43200f, _rectBounds.Y + 1f, sizeF4.Width, sizeF4.Height, -130f, 117f);
		pdfPath.AddArc(_rectBounds.Right - sizeF5.Width - 708f * _rectBounds.Width / 43200f, _rectBounds.Y + sizeF4.Height / 2f - 1127f * _rectBounds.Height / 43200f, sizeF5.Width, sizeF5.Height, -78f, 109f);
		pdfPath.AddArc(_rectBounds.Right - sizeF6.Width + 354f * _rectBounds.Width / 43200f, _rectBounds.Y + _rectBounds.Height / 2f - 9129f * _rectBounds.Height / 43200f, sizeF6.Width, sizeF6.Height, -46f, 130f);
		pdfPath.AddArc(_rectBounds.X + _rectBounds.Width / 2f + 4608f * _rectBounds.Width / 43200f, _rectBounds.Y + _rectBounds.Height / 2f + 869f * _rectBounds.Height / 43200f, sizeF7.Width, sizeF7.Height, 0f, 114f);
		pdfPath.AddArc(_rectBounds.X + _rectBounds.Width / 2f - sizeF8.Width / 2f + 886f * _rectBounds.Width / 43200f, _rectBounds.Bottom - sizeF8.Height, sizeF8.Width, sizeF8.Height, 22f, 115f);
		pdfPath.AddArc(_rectBounds.X + 4962f * _rectBounds.Width / 43200f, _rectBounds.Bottom - sizeF9.Height - 2173f * _rectBounds.Height / 43200f, sizeF9.Width, sizeF9.Height, 66f, 75f);
		pdfPath.AddArc(_rectBounds.X + 1063f * _rectBounds.Width / 43200f, _rectBounds.Y + _rectBounds.Height / 2f + 2608f * _rectBounds.Height / 43200f, sizeF10.Width, sizeF10.Height, -274f, 146f);
		pdfPath.AddArc(_rectBounds.X + 1f, _rectBounds.Y + _rectBounds.Height / 2f - sizeF11.Height / 2f - 1304f * _rectBounds.Height / 43200f, sizeF11.Width, sizeF11.Height, -246f, 152f);
		pdfPath.CloseFigure();
		pdfPath.AddArc(_rectBounds.X + _rectBounds.Width / 2f + 2658f * _rectBounds.Width / 43200f, _rectBounds.Y + _rectBounds.Height / 2f, _rectBounds.Width * 6753f / 43200f * 2f, _rectBounds.Height * 9190f / 43200f * 2f, -58f, 59f);
		return pdfPath;
	}
	...
	internal PdfPath GetDoubleBracketPath()
	{
		...
		PdfPath pdfPath = new PdfPath();
		pdfPath.AddArc(_rectBounds.X, _rectBounds.Bottom - dictionary["x1"] * 2f, dictionary["x1"] * 2f, dictionary["x1"] * 2f, 90f, 90f);
		pdfPath.AddArc(_rectBounds.X, _rectBounds.Y, dictionary["x1"] * 2f, dictionary["x1"] * 2f, 180f, 90f);
		pdfPath.StartFigure();
		pdfPath.AddArc(_rectBounds.X + dictionary["x2"] - dictionary["x1"], _rectBounds.Y, dictionary["x1"] * 2f, dictionary["x1"] * 2f, 270f, 90f);
		pdfPath.AddArc(_rectBounds.X + dictionary["x2"] - dictionary["x1"], _rectBounds.Y + dictionary["y2"] - dictionary["x1"], dictionary["x1"] * 2f, dictionary["x1"] * 2f, 0f, 90f);
		return pdfPath;
	}
	...
	internal PdfPath GetDoubleBracePath()
	{
		...
		PdfPath pdfPath = new PdfPath();
		pdfPath.AddArc(_rectBounds.X - dictionary["x1"] + dictionary["x2"], _rectBounds.Bottom - dictionary["x1"] * 2f, dictionary["x1"] * 2f, dictionary["x1"] * 2f, 90f, 90f);
		pdfPath.AddArc(_rectBounds.X - dictionary["x1"], _rectBounds.Y + dictionary["y3"] - dictionary["x1"], dictionary["x1"] * 2f, dictionary["x1"] * 2f, 0f, -90f);
		pdfPath.AddArc(_rectBounds.X - dictionary["x1"], _rectBounds.Y + dictionary["y3"] - dictionary["x1"] * 3f, dictionary["x1"] * 2f, dictionary["x1"] * 2f, 90f, -90f);
		pdfPath.AddArc(_rectBounds.X - dictionary["x1"] + dictionary["x2"], _rectBounds.Y, dictionary["x1"] * 2f, dictionary["x1"] * 2f, 180f, 90f);
		pdfPath.StartFigure();
		pdfPath.AddArc(_rectBounds.X + dictionary["x3"] - dictionary["x1"], _rectBounds.Top, dictionary["x1"] * 2f, dictionary["x1"] * 2f, 270f, 90f);
		pdfPath.AddArc(_rectBounds.Right - dictionary["x1"], _rectBounds.Y + dictionary["y2"] - dictionary["x1"], dictionary["x1"] * 2f, dictionary["x1"] * 2f, 180f, -90f);
		pdfPath.AddArc(_rectBounds.Right - dictionary["x1"], _rectBounds.Y + dictionary["y2"] + dictionary["x1"], dictionary["x1"] * 2f, dictionary["x1"] * 2f, 270f, -90f);
		pdfPath.AddArc(_rectBounds.X + dictionary["x3"] - dictionary["x1"], _rectBounds.Y + dictionary["y4"], dictionary["x1"] * 2f, dictionary["x1"], 0f, 90f);
		return pdfPath;
	}
	...
	internal PdfPath GetLeftBracketPath()
	{
		...
		PdfPath pdfPath = new PdfPath();
		pdfPath.AddArc(_rectBounds.Right - _rectBounds.Width, _rectBounds.Bottom - dictionary["y1"] * 2f, _rectBounds.Width * 2f, dictionary["y1"] * 2f, 90f, 90f);
		pdfPath.AddArc(_rectBounds.Right - _rectBounds.Width, _rectBounds.Y, _rectBounds.Width * 2f, dictionary["y1"] * 2f, 180f, 90f);
		return pdfPath;
	}
	...
	internal PdfPath GetRightBracketPath()
	{
		...
		PdfPath pdfPath = new PdfPath();
		pdfPath.AddArc(_rectBounds.X - _rectBounds.Width, _rectBounds.Y, _rectBounds.Width * 2f, dictionary["y1"] * 2f, 270f, 90f);
		pdfPath.AddArc(_rectBounds.X - _rectBounds.Width, _rectBounds.Y + dictionary["y2"] - dictionary["y1"], _rectBounds.Width * 2f, dictionary["y1"] * 2f, 0f, 90f);
		return pdfPath;
	}
	...
	internal PdfPath GetLeftBracePath()
	{
		...
		PdfPath pdfPath = new PdfPath();
		pdfPath.AddArc(_rectBounds.Right - _rectBounds.Width / 2f, _rectBounds.Bottom - dictionary["y1"] * 2f, _rectBounds.Width, dictionary["y1"] * 2f, 90f, 90f);
		pdfPath.AddArc(_rectBounds.X - _rectBounds.Width / 2f, _rectBounds.Y + dictionary["y4"] - dictionary["y1"], _rectBounds.Width, dictionary["y1"] * 2f, 0f, -90f);
		pdfPath.AddArc(_rectBounds.X - _rectBounds.Width / 2f, _rectBounds.Y + dictionary["y4"] - dictionary["y1"] * 3f, _rectBounds.Width, dictionary["y1"] * 2f, 90f, -90f);
		pdfPath.AddArc(_rectBounds.Right - _rectBounds.Width / 2f, _rectBounds.Y, _rectBounds.Width, dictionary["y1"] * 2f, 180f, 90f);
		return pdfPath;
	}
	...
	internal PdfPath GetRightBracePath()
	{
		...
		PdfPath pdfPath = new PdfPath();
		pdfPath.AddArc(_rectBounds.X - _rectBounds.Width / 2f, _rectBounds.Top, _rectBounds.Width, dictionary["y1"] * 2f, 270f, 90f);
		PointF pointF = new PointF(_rectBounds.X + _rectBounds.Width, _rectBounds.Y + dictionary["y2"] - dictionary["y1"]);
		pdfPath.AddArc(pointF.X - _rectBounds.Width / 2f, pointF.Y, _rectBounds.Width, dictionary["y1"] * 2f, 180f, -90f);
		pdfPath.AddArc(pointF.X - _rectBounds.Width / 2f, pointF.Y + dictionary["y1"] * 2f, _rectBounds.Width, dictionary["y1"] * 2f, 270f, -90f);
		pdfPath.AddArc(_rectBounds.X - _rectBounds.Width / 2f, _rectBounds.Y + dictionary["y4"] - dictionary["y1"], _rectBounds.Width, dictionary["y1"] * 2f, 0f, 90f);
		return pdfPath;
	}
	...
	internal PdfPath GetCurvedRightArrowPath()
	{
		...
		pdfPath.AddArc(array[0].X, array[0].Y - dictionary["hR"], _rectBounds.Width * 2f, dictionary["hR"] * 2f, 180f, dictionary["mswAng"]);
		array[1] = new PointF(_rectBounds.X + dictionary["x1"], _rectBounds.Y + dictionary["y4"]);
		...
		pdfPath.AddArc(array[4].X - dictionary["x1"], array[4].Y - dictionary["hR"] * 2f, _rectBounds.Width * 2f, dictionary["hR"] * 2f, dictionary["stAng"], dictionary["swAng"]);
		pdfPath.CloseFigure();
		array[5] = new PointF(_rectBounds.X, _rectBounds.Y + dictionary["hR"]);
		pdfPath.AddArc(array[5].X, array[5].Y - dictionary["hR"], _rectBounds.Width * 2f, dictionary["hR"] * 2f, 180f, 90f);
		array[6] = new PointF(_rectBounds.Right, _rectBounds.Y + dictionary["th"]);
		pdfPath.AddLine(array[5].X + _rectBounds.Width, array[5].Y - dictionary["hR"], array[6].X, array[6].Y);
		pdfPath.AddArc(array[6].X - _rectBounds.Width, array[6].Y, _rectBounds.Width * 2f, dictionary["hR"] * 2f, 270f, dictionary["swAng2"]);
		return pdfPath;
	}
	...
	internal PdfPath GetCurvedLeftArrowPath()
	{
		...
		pdfPath.AddArc(_rectBounds.Right - _rectBounds.Width * 2f, array[0].Y - dictionary["hR"], _rectBounds.Width * 2f, dictionary["hR"] * 2f, 0f, -90f);
		array[1] = new PointF(_rectBounds.X, _rectBounds.Y);
		pdfPath.AddArc(array[1].X - _rectBounds.Width, array[1].Y, _rectBounds.Width * 2f, dictionary["hR"] * 2f, 270f, 90f);
		array[2] = new PointF(_rectBounds.Right, _rectBounds.Y + dictionary["y3"]);
		pdfPath.AddArc(array[2].X - _rectBounds.Width * 2f, array[2].Y - dictionary["hR"], _rectBounds.Width * 2f, dictionary["hR"] * 2f, 0f, dictionary["swAng"]);
		array[3] = new PointF(_rectBounds.X + dictionary["x1"], _rectBounds.Y + dictionary["y8"]);
		array[4] = new PointF(_rectBounds.X, _rectBounds.Y + dictionary["y6"]);
		pdfPath.AddLine(array[3], array[4]);
		array[5] = new PointF(_rectBounds.X + dictionary["x1"], _rectBounds.Y + dictionary["y4"]);
		pdfPath.AddLine(array[4], array[5]);
		array[6] = new PointF(_rectBounds.X + dictionary["x1"], _rectBounds.Y + dictionary["y5"]);
		pdfPath.AddLine(array[5], array[6]);
		pdfPath.AddArc(_rectBounds.X - _rectBounds.Width, array[1].Y, _rectBounds.Width * 2f, dictionary["hR"] * 2f, dictionary["swAng"], dictionary["swAng2"]);
		return pdfPath;
	}
	...
	internal PdfPath GetCurvedUpArrowPath()
	{
		...
		pdfPath.AddArc(array[5].X - sizeF.Width, array[0].Y - sizeF.Height - dictionary["iy"], sizeF.Width * 2f, sizeF.Height * 2f, dictionary["stAng2"], dictionary["swAng2"]);
		pdfPath.AddLine(array[1], array[2]);
		pdfPath.AddLine(array[2], array[3]);
		pdfPath.AddLine(array[3], array[4]);
		pdfPath.AddArc(array[6].X, _rectBounds.Y - sizeF.Height, sizeF.Width * 2f, sizeF.Height * 2f, dictionary["stAng3"], dictionary["swAng"]);
		pdfPath.AddArc(array[5].X - sizeF.Width, array[5].Y - sizeF.Height * 2f, sizeF.Width * 2f, sizeF.Height * 2f, 90f, 90f);
		pdfPath.AddArc(array[6].X, array[6].Y - sizeF.Height, sizeF.Width * 2f, sizeF.Height * 2f, 180f, -90f);
		return pdfPath;
	}
	...
	internal PdfPath GetCurvedDownArrowPath()
	{
		...
		pdfPath.AddArc(array[2].X - sizeF.Width, _rectBounds.Y, sizeF.Width * 2f, sizeF.Height * 2f, dictionary["stAng2"], dictionary["swAng2"]);
		pdfPath.AddArc(_rectBounds.X, _rectBounds.Y, sizeF.Width * 2f, sizeF.Height * 2f, 180f, 90f);
		pdfPath.AddArc(_rectBounds.X, _rectBounds.Y, sizeF.Width * 2f, sizeF.Height * 2f, 270f, dictionary["swAng"]);
		pdfPath.AddLine(array[6], array[5]);
		pdfPath.AddLine(array[5], array[4]);
		pdfPath.AddLine(array[4], array[3]);
		pdfPath.AddLine(array[3], new PointF(array[3].X - dictionary["x5"] + dictionary["x4"], array[3].Y));
		pdfPath.AddArc(array[2].X - sizeF.Width, _rectBounds.Y, sizeF.Width * 2f, sizeF.Height * 2f, dictionary["stAng"], dictionary["mswAng"]);
		pdfPath.AddLines(new PointF[1]
		{
	...
	internal PdfPath GetQuadArrowPath()
	{
		...
		PdfPath pdfPath = new PdfPath();
		pdfPath.AddLines(new PointF[24]
		{
			new PointF(_rectBounds.X, _rectBounds.Y + _rectBounds.Height / 2f),
			new PointF(_rectBounds.X + dictionary["x1"], _rectBounds.Y + dictionary["y2"]),
			new PointF(_rectBounds.X + dictionary["x1"], _rectBounds.Y + dictionary["y3"]),
	...
	internal PdfPath GetLeftRightUpArrowPath()
	{
		...
		PdfPath pdfPath = new PdfPath();
		pdfPath.AddLines(new PointF[17]
		{
	...
	internal PdfPath GetBentArrowPath()
	{
		...
		PdfPath pdfPath = new PdfPath();
		PointF[] array = new PointF[6];
		pdfPath.AddLine(_rectBounds.X, _rectBounds.Bottom, _rectBounds.X, _rectBounds.Y + dictionary["y5"]);
		pdfPath.AddArc(_rectBounds.X, _rectBounds.Y + dictionary["y5"] - dictionary["bd"], dictionary["bd"] * 2f, dictionary["bd"] * 2f, 180f, 90f);
		...
		pdfPath.AddArc(array[5].X - dictionary["bd2"], array[5].Y, dictionary["bd2"] * 2f, dictionary["bd2"] * 2f, 270f, -90f);
		pdfPath.AddLine(array[5].X - dictionary["bd2"], array[5].Y + dictionary["bd2"], _rectBounds.X + dictionary["th"], _rectBounds.Bottom);
		pdfPath.CloseFigure();
		return pdfPath;
	}
	...
	internal PdfPath GetUTrunArrowPath()
	{
		...
		pdfPath.AddLine(array[0], array[1]);
		pdfPath.AddArc(array[1].X, array[1].Y - dictionary["bd"], dictionary["bd"] * 2f, dictionary["bd"] * 2f, 180f, 90f);
		array[2] = new PointF(_rectBounds.X + dictionary["x4"], _rectBounds.Y);
		pdfPath.AddLine(array[1].X + dictionary["bd"], array[1].Y - dictionary["bd"], array[2].X, array[2].Y);
		pdfPath.AddArc(array[2].X - dictionary["bd"], array[2].Y, dictionary["bd"] * 2f, dictionary["bd"] * 2f, 270f, 90f);
		array[3] = new PointF(_rectBounds.X + dictionary["x9"], _rectBounds.Y + dictionary["y4"]);
		pdfPath.AddLine(array[2].X + dictionary["bd"], array[2].Y + dictionary["bd"], array[3].X, array[3].Y);
		...
		pdfPath.AddLine(array[6], array[7]);
		array[8] = new PointF(_rectBounds.X + dictionary["x7"], _rectBounds.Y + dictionary["x3"]);
		pdfPath.AddLine(array[7], array[8]);
		pdfPath.AddArc(array[8].X - dictionary["bd2"] * 2f, array[8].Y - dictionary["bd2"], dictionary["bd2"] * 2f, dictionary["bd2"] * 2f, 0f, -90f);
		array[9] = new PointF(_rectBounds.X + dictionary["x3"], _rectBounds.Y + dictionary["th"]);
		pdfPath.AddLine(array[8].X - dictionary["bd2"], array[8].Y - dictionary["bd2"], array[9].X, array[9].Y);
		pdfPath.AddArc(array[9].X - dictionary["bd2"], array[9].Y, dictionary["bd2"] * 2f, dictionary["bd2"] * 2f, 270f, -90f);
		array[10] = new PointF(_rectBounds.X + dictionary["th"], _rectBounds.Bottom);
		pdfPath.AddLine(array[9].X - dictionary["bd2"], array[9].Y + dictionary["bd2"], array[10].X, array[10].Y);
		pdfPath.CloseFigure();
		return pdfPath;
	}
	...
	internal PdfPath GetLeftRightArrowCalloutPath()
	{
		...
		PdfPath pdfPath = new PdfPath();
		pdfPath.AddLines(new PointF[18]
		{
			new PointF(_rectBounds.X, _rectBounds.Y + _rectBounds.Height / 2f),
			new PointF(_rectBounds.X + dictionary["x1"], _rectBounds.Y + dictionary["y1"]),
			new PointF(_rectBounds.X + dictionary["x1"], _rectBounds.Y + dictionary["y2"]),
	...
	internal PdfPath GetQuadArrowCalloutPath()
	{
		...
		PdfPath pdfPath = new PdfPath();
		pdfPath.AddLines(new PointF[32]
		{
			new PointF(_rectBounds.X, _rectBounds.Y + _rectBounds.Height / 2f),
	...
	internal PdfPath GetCircularArrowPath()
	{
		...
		pdfPath.AddArc(array[0].X - sizeF.Width * 2f, array[0].Y - sizeF.Height, sizeF.Width * 2f, sizeF.Height * 2f, dictionary["stAng"], dictionary["swAng"]);
		...
		pdfPath.AddLine(new PointF(array[1].X - (array[4].X - array[3].X), array[1].Y), array[1]);
		pdfPath.AddLine(array[1], array[2]);
		pdfPath.AddLine(array[2], array[3]);
		pdfPath.AddLine(array[3], array[4]);
		SizeF sizeF2 = new SizeF(dictionary["rw2"], dictionary["rh2"]);
		pdfPath.AddArc(array[0].X - sizeF.Width - sizeF2.Width, array[0].Y - sizeF2.Height, sizeF2.Width * 2f, sizeF2.Height * 2f, dictionary["istAng"], dictionary["iswAng"]);
		pdfPath.CloseFigure();
		return pdfPath;
	}
	...
	internal PdfPath GetMathDivisionPath()
	{
		...
		PdfPath pdfPath = new PdfPath();
		PointF[] array = new PointF[4];
		pdfPath.AddEllipse(_rectBounds.X + _rectBounds.Width / 2f - dictionary["rad"], _rectBounds.Y + dictionary["y1"], dictionary["rad"] * 2f, dictionary["rad"] * 2f);
		pdfPath.CloseFigure();
		pdfPath.AddEllipse(_rectBounds.X + _rectBounds.Width / 2f - dictionary["rad"], _rectBounds.Y + dictionary["y5"] - dictionary["rad"] * 2f, dictionary["rad"] * 2f, dictionary["rad"] * 2f);
		pdfPath.CloseFigure();
	...
	internal PdfPath GetMathNotEqualPath()
	{
		...
		PdfPath pdfPath = new PdfPath();
		pdfPath.AddLines(new PointF[20]
		{
			new PointF(_rectBounds.X + dictionary["x1"], _rectBounds.Y + dictionary["y1"]),
	...
	{
		PdfPath pdfPath = new PdfPath();
		pdfPath.AddRectangle(_rectBounds);
		pdfPath.AddLine(_rectBounds.X + _rectBounds.Width / 8f, _rectBounds.Y, _rectBounds.X + _rectBounds.Width / 8f, _rectBounds.Bottom);
		pdfPath.CloseFigure();
		pdfPath.AddLine(_rectBounds.Right - _rectBounds.Width / 8f, _rectBounds.Y, _rectBounds.Right - _rectBounds.Width / 8f, _rectBounds.Bottom);
		pdfPath.CloseFigure();
		return pdfPath;
	}
	...
	internal PdfPath GetFlowChartInternalStoragePath()
	{
		...
		pdfPath.AddLine(_rectBounds.X + _rectBounds.Width / 8f, _rectBounds.Y, _rectBounds.X + _rectBounds.Width / 8f, _rectBounds.Bottom);
		pdfPath.CloseFigure();
		pdfPath.AddLine(_rectBounds.X, _rectBounds.Y + _rectBounds.Height / 8f, _rectBounds.Right, _rectBounds.Top + _rectBounds.Height / 8f);
		pdfPath.CloseFigure();
		return pdfPath;
	}
	...
	{
		PdfPath pdfPath = new PdfPath();
		pdfPath.AddLine(_rectBounds.X, _rectBounds.Y, _rectBounds.Right, _rectBounds.Y);
		pdfPath.AddLine(_rectBounds.Right, _rectBounds.Y, _rectBounds.Right, _rectBounds.Y + _rectBounds.Height * 17322f / 21600f);
		...
		pdfPath.AddBezier(xYPosition, xYPosition2, xYPosition3, xYPosition4);
		pdfPath.CloseFigure();
		return pdfPath;
	}
	...
	{
		PdfPath pdfPath = new PdfPath();
		pdfPath.AddLine(GetXYPosition(0f, 3675f, 21600f), GetXYPosition(18595f, 3675f, 21600f));
		pdfPath.AddLine(GetXYPosition(18595f, 3675f, 21600f), GetXYPosition(18595f, 18022f, 21600f));
		pdfPath.AddBezier(GetXYPosition(18595f, 18022f, 21600f), GetXYPosition(9298f, 18022f, 21600f), GetXYPosition(9298f, 23542f, 21600f), GetXYPosition(0f, 20782f, 21600f));
		pdfPath.CloseFigure();
		pdfPath.AddLine(GetXYPosition(1532f, 3675f, 21600f), GetXYPosition(1532f, 1815f, 21600f));
		pdfPath.AddLine(GetXYPosition(1532f, 1815f, 21600f), GetXYPosition(20000f, 1815f, 21600f));
		pdfPath.AddLine(GetXYPosition(20000f, 1815f, 21600f), GetXYPosition(20000f, 16252f, 21600f));
		pdfPath.AddBezier(GetXYPosition(20000f, 16252f, 21600f), GetXYPosition(19298f, 16252f, 21600f), GetXYPosition(18595f, 16352f, 21600f), GetXYPosition(18595f, 16352f, 21600f));
		pdfPath.StartFigure();
		pdfPath.AddLine(GetXYPosition(2972f, 1815f, 21600f), GetXYPosition(2972f, 0f, 21600f));
		pdfPath.AddLine(GetXYPosition(2972f, 0f, 21600f), GetXYPosition(21600f, 0f, 21600f));
		pdfPath.AddLine(GetXYPosition(21600f, 0f, 21600f), GetXYPosition(21600f, 14392f, 21600f));
		pdfPath.AddBezier(GetXYPosition(21600f, 14392f, 21600f), GetXYPosition(20800f, 14392f, 21600f), GetXYPosition(20000f, 14467f, 21600f), GetXYPosition(20000f, 14467f, 21600f));
		return pdfPath;
	}
	...
	internal PdfPath GetFlowChartTerminatorPath()
	{
		...
		pdfPath.AddLine(GetXYPosition(3475f, 0f, 21600f), GetXYPosition(18125f, 0f, 21600f));
		pdfPath.StartFigure();
		PointF xYPosition = GetXYPosition(18125f, 0f, 21600f);
		RectangleF rectangle = new RectangleF(xYPosition.X - sizeF.Width / 2f, xYPosition.Y, sizeF.Width, sizeF.Height);
		pdfPath.AddArc(rectangle, 270f, 180f);
		pdfPath.AddLine(new PointF(rectangle.X, rectangle.Y + rectangle.Height), GetXYPosition(3475f, 21600f, 21600f));
		xYPosition = GetXYPosition(3475f, 0f, 21600f);
		rectangle = new RectangleF(xYPosition.X - sizeF.Width / 2f, xYPosition.Y, sizeF.Width, sizeF.Height);
		pdfPath.AddArc(rectangle, 90f, 180f);
		pdfPath.CloseFigure();
		return pdfPath;
	}
	...
	{
		PdfPath pdfPath = new PdfPath();
		pdfPath.AddLine(GetXYPosition(0f, 5f, 10f), GetXYPosition(2f, 0f, 10f));
		pdfPath.AddLine(GetXYPosition(2f, 0f, 10f), GetXYPosition(8f, 0f, 10f));
		pdfPath.AddLine(GetXYPosition(8f, 0f, 10f), GetXYPosition(10f, 5f, 10f));
		pdfPath.AddLine(GetXYPosition(10f, 5f, 10f), GetXYPosition(8f, 10f, 10f));
		pdfPath.AddLine(GetXYPosition(8f, 10f, 10f), GetXYPosition(2f, 10f, 10f));
		pdfPath.CloseFigure();
		return pdfPath;
	}
	...
	{
		PdfPath pdfPath = new PdfPath();
		pdfPath.AddLine(GetXYPosition(0f, 1f, 5f), GetXYPosition(5f, 0f, 5f));
		pdfPath.AddLine(GetXYPosition(5f, 0f, 5f), GetXYPosition(5f, 5f, 5f));
		pdfPath.AddLine(GetXYPosition(5f, 5f, 5f), GetXYPosition(0f, 5f, 5f));
		pdfPath.CloseFigure();
		return pdfPath;
	}
	...
	{
		PdfPath pdfPath = new PdfPath();
		pdfPath.AddLine(GetXYPosition(0f, 0f, 5f), GetXYPosition(5f, 0f, 5f));
		pdfPath.AddLine(GetXYPosition(5f, 0f, 5f), GetXYPosition(4f, 5f, 5f));
		pdfPath.AddLine(GetXYPosition(4f, 5f, 5f), GetXYPosition(1f, 5f, 5f));
		pdfPath.CloseFigure();
		return pdfPath;
	}
	...
	{
		PdfPath pdfPath = new PdfPath();
		RectangleF rectangle = new RectangleF(new PointF(_rectBounds.X, _rectBounds.Y), new SizeF(_rectBounds.Width, _rectBounds.Height));
		pdfPath.AddArc(rectangle, 180f, 90f);
		pdfPath.AddArc(rectangle, 270f, 90f);
		pdfPath.AddArc(rectangle, 0f, 90f);
		pdfPath.AddArc(rectangle, 90f, 90f);
	...
	{
		PdfPath pdfPath = new PdfPath();
		pdfPath.AddLine(GetXYPosition(0f, 0f, 10f), GetXYPosition(10f, 0f, 10f));
		pdfPath.AddLine(GetXYPosition(10f, 0f, 10f), GetXYPosition(10f, 8f, 10f));
		pdfPath.AddLine(GetXYPosition(10f, 8f, 10f), GetXYPosition(5f, 10f, 10f));
		pdfPath.AddLine(GetXYPosition(5f, 10f, 10f), GetXYPosition(0f, 8f, 10f));
		pdfPath.CloseFigure();
		return pdfPath;
	}
	...
	{
		PdfPath pdfPath = new PdfPath();
		pdfPath.AddLine(GetXYPosition(0f, 1f, 5f), GetXYPosition(1f, 0f, 5f));
		pdfPath.AddLine(GetXYPosition(1f, 0f, 5f), GetXYPosition(5f, 0f, 5f));
		pdfPath.AddLine(GetXYPosition(5f, 0f, 5f), GetXYPosition(5f, 5f, 5f));
		pdfPath.AddLine(GetXYPosition(5f, 5f, 5f), GetXYPosition(0f, 5f, 5f));
		pdfPath.CloseFigure();
		return pdfPath;
	...
	{
		PdfPath pdfPath = new PdfPath();
		RectangleF rectangle = new RectangleF(GetXYPosition(0f, 2f, 20f), new SizeF(_rectBounds.Width * 5f / 20f * 2f, _rectBounds.Height * 2f / 20f * 2f));
		pdfPath.AddArc(rectangle, 180f, -180f);
		PointF location = new PointF(rectangle.X + rectangle.Width, rectangle.Y);
		rectangle = new RectangleF(location, new SizeF(_rectBounds.Width * 5f / 20f * 2f, _rectBounds.Height * 2f / 20f * 2f));
		pdfPath.AddArc(rectangle, 180f, 180f);
		pdfPath.AddLine(new PointF(rectangle.X + rectangle.Width, rectangle.Y + rectangle.Height), GetXYPosition(20f, 18f, 20f));
		rectangle = new RectangleF(new PointF(GetXYPosition(20f, 18f, 20f).X - rectangle.Width, GetXYPosition(20f, 18f, 20f).Y), new SizeF(_rectBounds.Width * 5f / 20f * 2f, _rectBounds.Height * 2f / 20f * 2f));
		pdfPath.AddArc(rectangle, 0f, -180f);
	...
	internal PdfPath GetFlowChartSummingJunctionPath()
	{
		...
		pdfPath.AddLine(new PointF(_rectBounds.X + dictionary["il"], _rectBounds.Y + dictionary["it"]), new PointF(_rectBounds.X + dictionary["ir"], _rectBounds.Y + dictionary["ib"]));
		pdfPath.StartFigure();
		pdfPath.AddLine(new PointF(_rectBounds.X + dictionary["ir"], _rectBounds.Y + dictionary["it"]), new PointF(_rectBounds.X + dictionary["il"], _rectBounds.Y + dictionary["ib"]));
		pdfPath.StartFigure();
		pdfPath.AddArc(_rectBounds, 180f, 90f);
		pdfPath.AddArc(_rectBounds, 270f, 90f);
		pdfPath.AddArc(_rectBounds, 0f, 90f);
		pdfPath.AddArc(_rectBounds, 90f, 90f);
		pdfPath.CloseFigure();
		return pdfPath;
	}
	...
	{
		PdfPath pdfPath = new PdfPath();
		pdfPath.AddLine(new PointF(_rectBounds.X + _rectBounds.Width / 2f, _rectBounds.Y), new PointF(_rectBounds.X + _rectBounds.Width / 2f, _rectBounds.Bottom));
		pdfPath.StartFigure();
		pdfPath.AddLine(new PointF(_rectBounds.X, _rectBounds.Y + _rectBounds.Height / 2f), new PointF(_rectBounds.Right, _rectBounds.Y + _rectBounds.Height / 2f));
		pdfPath.StartFigure();
		pdfPath.AddArc(_rectBounds, 180f, 90f);
		pdfPath.AddArc(_rectBounds, 270f, 90f);
		pdfPath.AddArc(_rectBounds, 0f, 90f);
	...
	{
		PdfPath pdfPath = new PdfPath();
		pdfPath.AddLine(GetXYPosition(0f, 0f, 2f), GetXYPosition(2f, 0f, 2f));
		pdfPath.AddLine(GetXYPosition(2f, 0f, 2f), GetXYPosition(1f, 1f, 2f));
		pdfPath.AddLine(GetXYPosition(1f, 1f, 2f), GetXYPosition(2f, 2f, 2f));
		pdfPath.AddLine(GetXYPosition(2f, 2f, 2f), GetXYPosition(0f, 2f, 2f));
		pdfPath.AddLine(GetXYPosition(0f, 2f, 2f), GetXYPosition(1f, 1f, 2f));
		pdfPath.CloseFigure();
		return pdfPath;
	}
	...
	{
		PdfPath pdfPath = new PdfPath();
		pdfPath.AddLine(GetXYPosition(0f, 1f, 2f), GetXYPosition(2f, 1f, 2f));
		pdfPath.AddLine(GetXYPosition(2f, 1f, 2f), GetXYPosition(0f, 1f, 2f));
		pdfPath.AddLine(GetXYPosition(0f, 1f, 2f), GetXYPosition(1f, 0f, 2f));
		pdfPath.AddLine(GetXYPosition(1f, 0f, 2f), GetXYPosition(2f, 1f, 2f));
		pdfPath.AddLine(GetXYPosition(2f, 1f, 2f), GetXYPosition(1f, 2f, 2f));
		pdfPath.CloseFigure();
		return pdfPath;
	}
	...
	{
		PdfPath pdfPath = new PdfPath();
		pdfPath.AddLine(GetXYPosition(0f, 2f, 2f), GetXYPosition(1f, 0f, 2f));
		pdfPath.AddLine(GetXYPosition(1f, 0f, 2f), GetXYPosition(2f, 2f, 2f));
		pdfPath.CloseFigure();
		return pdfPath;
	}
	...
	internal PdfPath GetFlowChartMergePath()
	{
		PdfPath pdfPath = new PdfPath();
		pdfPath.AddLine(GetXYPosition(0f, 0f, 2f), GetXYPosition(2f, 0f, 2f));
		pdfPath.AddLine(GetXYPosition(2f, 0f, 2f), GetXYPosition(1f, 2f, 2f));
		pdfPath.CloseFigure();
		return pdfPath;
	}
	...
	{
		PdfPath pdfPath = new PdfPath();
		pdfPath.AddLine(GetXYPosition(1f, 0f, 6f), GetXYPosition(6f, 0f, 6f));
		SizeF sizeF = new SizeF(_rectBounds.Width / 6f * 2f, _rectBounds.Height / 2f * 2f);
		PointF xYPosition = GetXYPosition(6f, 0f, 6f);
		RectangleF rectangle = new RectangleF(xYPosition.X - sizeF.Width / 2f, xYPosition.Y, sizeF.Width, sizeF.Height);
		pdfPath.AddArc(rectangle, 270f, -180f);
		pdfPath.AddLine(new PointF(xYPosition.X, xYPosition.Y + sizeF.Height), GetXYPosition(1f, 6f, 6f));
	...
	{
		PdfPath pdfPath = new PdfPath();
		pdfPath.AddLine(new PointF(_rectBounds.X, _rectBounds.Y), new PointF(_rectBounds.X + _rectBounds.Width / 2f, _rectBounds.Y));
		...
		pdfPath.AddArc(rectangle, 270f, 180f);
		pdfPath.AddLine(new PointF(pointF.X, pointF.Y + sizeF.Height), new PointF(_rectBounds.X, _rectBounds.Bottom));
		pdfPath.CloseFigure();
		return pdfPath;
	}
	...
	internal PdfPath GetFlowChartSequentialAccessStoragePath()
	{
		...
		SizeF sizeF = new SizeF(_rectBounds.Width, _rectBounds.Height);
		RectangleF rectangle = new RectangleF(_rectBounds.X, _rectBounds.Y, sizeF.Width, sizeF.Height);
		pdfPath.AddArc(rectangle, 90f, 90f);
		pdfPath.AddArc(rectangle, 180f, 90f);
		pdfPath.AddArc(rectangle, 270f, 90f);
		pdfPath.AddArc(rectangle, 0f, dictionary["ang1"]);
		pdfPath.AddLine(new PointF(_rectBounds.Right, _rectBounds.Y + dictionary["ib"]), new PointF(_rectBounds.Right, _rectBounds.Bottom));
		pdfPath.CloseFigure();
		return pdfPath;
	}
	...
	internal PdfPath GetFlowChartMagneticDiskPath()
	{
		...
		RectangleF rectangle = new RectangleF(xYPosition.X - sizeF.Width, xYPosition.Y - sizeF.Height / 2f, sizeF.Width, sizeF.Height);
		pdfPath.AddArc(rectangle, 0f, 180f);
		pdfPath.StartFigure();
		xYPosition = GetXYPosition(0f, 1f, 6f);
		rectangle = new RectangleF(xYPosition.X, xYPosition.Y - sizeF.Height / 2f, sizeF.Width, sizeF.Height);
		pdfPath.AddArc(rectangle, 180f, 180f);
		pdfPath.AddLine(new PointF(rectangle.X + rectangle.Width, rectangle.Y + sizeF.Height), GetXYPosition(6f, 5f, 6f));
		xYPosition = GetXYPosition(6f, 5f, 6f);
		rectangle = new RectangleF(xYPosition.X - sizeF.Width, xYPosition.Y - sizeF.Height / 2f, sizeF.Width, sizeF.Height);
		pdfPath.AddArc(rectangle, 0f, 180f);
		pdfPath.CloseFigure();
		return pdfPath;
	}
	...
	internal PdfPath GetFlowChartDirectAccessStoragePath()
	{
		...
		RectangleF rectangle = new RectangleF(xYPosition.X - sizeF.Width / 2f, xYPosition.Y - sizeF.Height, sizeF.Width, sizeF.Height);
		pdfPath.AddArc(rectangle, 90f, 180f);
		pdfPath.StartFigure();
		pdfPath.AddLine(GetXYPosition(1f, 0f, 6f), GetXYPosition(5f, 0f, 6f));
		xYPosition = GetXYPosition(5f, 0f, 6f);
		rectangle = new RectangleF(xYPosition.X - sizeF.Width / 2f, xYPosition.Y, sizeF.Width, sizeF.Height);
		pdfPath.AddArc(rectangle, 270f, 180f);
		pdfPath.AddLine(new PointF(rectangle.X, rectangle.Y + sizeF.Height), GetXYPosition(1f, 6f, 6f));
		xYPosition = GetXYPosition(1f, 6f, 6f);
		rectangle = new RectangleF(xYPosition.X - sizeF.Width / 2f, xYPosition.Y - sizeF.Height, sizeF.Width, sizeF.Height);
		pdfPath.StartFigure();
		pdfPath.AddArc(rectangle, 90f, 180f);
		return pdfPath;
	}
	...
	{
		PdfPath pdfPath = new PdfPath();
		pdfPath.AddLine(GetXYPosition(0f, 3f, 6f), GetXYPosition(1f, 0f, 6f));
		pdfPath.AddLine(GetXYPosition(1f, 0f, 6f), GetXYPosition(5f, 0f, 6f));
		pdfPath.AddArc(GetXYPosition(5f, 0f, 6f).X - _rectBounds.Width / 6f, GetXYPosition(5f, 0f, 6f).Y, _rectBounds.Width / 3f, _rectBounds.Height, 270f, 180f);
		pdfPath.AddLine(new PointF(GetXYPosition(5f, 0f, 6f).X - _rectBounds.Width / 6f, GetXYPosition(5f, 0f, 6f).Y + _rectBounds.Height), GetXYPosition(1f, 6f, 6f));
		pdfPath.CloseFigure();
		return pdfPath;
	}
	...
	{
		PdfPath pdfPath = new PdfPath();
		pdfPath.AddLines(new PointF[28]
		{
	...
	internal PdfPath GetStar7Point()
	{
		...
		PdfPath pdfPath = new PdfPath();
		pdfPath.AddLines(new PointF[14]
		{
			new PointF(_rectBounds.X + dictionary["x1"], _rectBounds.Y + dictionary["y2"]),
			new PointF(_rectBounds.X + dictionary["sx1"], _rectBounds.Y + dictionary["sy2"]),
			new PointF(_rectBounds.X + dictionary["x2"], _rectBounds.Y + dictionary["y1"]),
	...
	internal PdfPath GetStar8Point()
	{
		...
		PdfPath pdfPath = new PdfPath();
		pdfPath.AddLines(new PointF[16]
		{
			new PointF(_rectBounds.X, _rectBounds.Y + _rectBounds.Height / 2f),
			new PointF(_rectBounds.X + dictionary["sx1"], _rectBounds.Y + dictionary["sy2"]),
			new PointF(_rectBounds.X + dictionary["x1"], _rectBounds.Y + dictionary["y1"]),
	...
	internal PdfPath GetStar24Point()
	{
		...
		PdfPath pdfPath = new PdfPath();
		pdfPath.AddLines(new PointF[48]
		{
			new PointF(_rectBounds.X, _rectBounds.Y + _rectBounds.Height / 2f),
	...
	internal PdfPath GetStar32Point()
	{
		...
		PdfPath pdfPath = new PdfPath();
		pdfPath.AddLines(new PointF[64]
		{
			new PointF(_rectBounds.X, _rectBounds.Y + _rectBounds.Height / 2f),
	...
	internal PdfPath GetUpRibbon()
	{
		...
		pdfPath.AddLine(array[3], array[4]);
		pdfPath.AddArc(array[4].X, array[4].Y - dictionary["hR"], _rectBounds.Width / 32f * 2f, dictionary["hR"] * 2f, 180f, 90f);
		array[5] = new PointF(_rectBounds.X + dictionary["x8"], _rectBounds.Y);
		pdfPath.AddLine(new PointF(array[4].X + _rectBounds.Width / 32f, array[4].Y - dictionary["hR"]), new PointF(array[5].X - _rectBounds.Width / 32f, array[5].Y));
		pdfPath.AddArc(array[5].X - _rectBounds.Width / 16f, array[5].Y, _rectBounds.Width / 32f * 2f, dictionary["hR"] * 2f, 270f, 90f);
		array[6] = new PointF(_rectBounds.X + dictionary["x9"], _rectBounds.Y + dictionary["y4"]);
		pdfPath.AddLine(new PointF(array[5].X, array[5].Y + dictionary["hR"]), array[6]);
		...
		pdfPath.AddLine(array[8], array[9]);
		array[10] = new PointF(_rectBounds.Right, _rectBounds.Bottom);
		pdfPath.AddLine(array[9], array[10]);
		array[11] = new PointF(_rectBounds.X + dictionary["x7"], _rectBounds.Bottom);
		pdfPath.AddLine(array[10], new PointF(array[11].X + _rectBounds.Width / 32f, array[11].Y));
		pdfPath.AddArc(array[11].X, array[11].Y - dictionary["hR"] * 2f, _rectBounds.Width / 32f * 2f, dictionary["hR"] * 2f, 90f, 180f);
		array[12] = new PointF(_rectBounds.X + dictionary["x8"], _rectBounds.Y + dictionary["y1"]);
		pdfPath.AddLine(new PointF(array[11].X + _rectBounds.Width / 32f, array[11].Y - dictionary["hR"] * 2f), new PointF(array[12].X - _rectBounds.Width / 32f, array[12].Y));
		pdfPath.AddArc(array[12].X - _rectBounds.Width / 32f * 2f, array[12].Y - dictionary["hR"] * 2f, _rectBounds.Width / 32f * 2f, dictionary["hR"] * 2f, 90f, -180f);
		array[13] = new PointF(_rectBounds.X + dictionary["x3"], _rectBounds.Y + dictionary["y2"]);
		pdfPath.AddLine(new PointF(array[12].X - _rectBounds.Width / 32f * 2f, array[12].Y - dictionary["hR"] * 2f), new PointF(array[13].X + _rectBounds.Width / 32f, array[13].Y));
		pdfPath.AddArc(array[13].X, array[13].Y, _rectBounds.Width / 32f * 2f, dictionary["hR"] * 2f, 270f, -180f);
		array[14] = new PointF(_rectBounds.X + dictionary["x4"], _rectBounds.Y + dictionary["y1"]);
		pdfPath.AddLine(new PointF(array[13].X + _rectBounds.Width / 32f, array[13].Y + dictionary["hR"] * 2f), new PointF(array[14].X - _rectBounds.Width / 32f, array[14].Y));
		pdfPath.AddArc(array[14].X - _rectBounds.Width / 32f * 2f, array[14].Y, _rectBounds.Width / 32f * 2f, dictionary["hR"] * 2f, 270f, 180f);
		pdfPath.CloseFigure();
		pdfPath.StartFigure();
		...
		pdfPath.AddLine(array[15], array[16]);
		pdfPath.StartFigure();
		...
		pdfPath.AddLine(array[17], array[18]);
		pdfPath.StartFigure();
		...
		pdfPath.AddLine(array[19], array[20]);
		pdfPath.StartFigure();
		...
		pdfPath.AddLine(array[21], array[22]);
		return pdfPath;
	}
	...
	internal PdfPath GetDownRibbon()
	{
		...
		pdfPath.AddLine(array[0], new PointF(array[1].X - _rectBounds.Width / 32f, array[1].Y));
		pdfPath.AddArc(array[1].X - _rectBounds.Width / 32f * 2f, array[1].Y, _rectBounds.Width / 32f * 2f, dictionary["hR"] * 2f, 270f, 180f);
		array[2] = new PointF(_rectBounds.X + dictionary["x3"], _rectBounds.Y + dictionary["y1"]);
		pdfPath.AddLine(new PointF(array[1].X - _rectBounds.Width / 32f, array[1].Y + dictionary["hR"] * 2f), new PointF(array[2].X + _rectBounds.Width / 32f, array[2].Y));
		pdfPath.AddArc(array[2].X, array[2].Y, _rectBounds.Width / 32f * 2f, dictionary["hR"] * 2f, 270f, -180f);
		array[3] = new PointF(_rectBounds.X + dictionary["x8"], _rectBounds.Y + dictionary["y2"]);
		pdfPath.AddLine(new PointF(array[2].X + _rectBounds.Width / 32f, array[2].Y + dictionary["hR"] * 2f), new PointF(array[3].X - _rectBounds.Width / 32f, array[3].Y));
		pdfPath.AddArc(array[3].X - _rectBounds.Width / 32f * 2f, array[3].Y - dictionary["hR"] * 2f, _rectBounds.Width / 32f * 2f, dictionary["hR"] * 2f, 90f, -180f);
		array[4] = new PointF(_rectBounds.X + dictionary["x7"], _rectBounds.Y + dictionary["y1"]);
		pdfPath.AddLine(new PointF(array[3].X - _rectBounds.Width / 32f, array[3].Y - dictionary["hR"] * 2f), new PointF(array[4].X + _rectBounds.Width / 32f, array[4].Y));
		pdfPath.AddArc(array[4].X, array[4].Y - dictionary["hR"] * 2f, _rectBounds.Width / 32f * 2f, dictionary["hR"] * 2f, 90f, 180f);
		array[5] = new PointF(_rectBounds.Right, _rectBounds.Y);
		pdfPath.AddLine(new PointF(array[4].X + _rectBounds.Width / 32f, array[4].Y - dictionary["hR"] * 2f), array[5]);
		...
		pdfPath.AddLine(array[8], array[9]);
		pdfPath.AddArc(array[9].X - _rectBounds.Width / 32f * 2f, array[9].Y - dictionary["hR"], _rectBounds.Width / 32f * 2f, dictionary["hR"] * 2f, 0f, 90f);
		array[10] = new PointF(_rectBounds.X + dictionary["x3"], _rectBounds.Bottom);
		pdfPath.AddLine(new PointF(array[9].X - _rectBounds.Width / 32f, array[9].Y + dictionary["hR"]), new PointF(array[10].X + _rectBounds.Width / 32f, array[10].Y));
		pdfPath.AddArc(array[10].X, array[10].Y - dictionary["hR"] * 2f, _rectBounds.Width / 32f * 2f, dictionary["hR"] * 2f, 90f, 90f);
		array[11] = new PointF(_rectBounds.X + dictionary["x2"], _rectBounds.Y + dictionary["y4"]);
		pdfPath.AddLine(new PointF(array[10].X, array[10].Y - dictionary["hR"]), array[11]);
		array[12] = new PointF(_rectBounds.X, _rectBounds.Y + dictionary["y4"]);
		pdfPath.AddLine(array[11], array[12]);
		array[13] = new PointF(_rectBounds.X + _rectBounds.Width / 8f, _rectBounds.Y + dictionary["y3"]);
		pdfPath.AddLine(array[12], array[13]);
		pdfPath.CloseFigure();
		array[14] = new PointF(_rectBounds.X + dictionary["x5"], _rectBounds.Y + dictionary["hR"]);
		array[15] = new PointF(_rectBounds.X + dictionary["x5"], _rectBounds.Y + dictionary["y2"]);
		pdfPath.AddLine(array[14], array[15]);
		pdfPath.StartFigure();
		...
		pdfPath.AddLine(array[16], array[17]);
		pdfPath.StartFigure();
		...
		pdfPath.AddLine(array[18], array[19]);
		pdfPath.StartFigure();
	...
	internal PdfPath GetCurvedUpRibbon()
	{
		...
		pdfPath.AddLines(new PointF[2]
		{
			array[0],
			array[1]
		});
		pdfPath.AddBezier(array[2], array[2], array[3], array[4]);
		...
		pdfPath.AddBezier(array2[0], array2[0], array2[1], array2[2]);
		...
		pdfPath.AddBezier(array3[0], array3[0], array3[1], array3[2]);
		...
		pdfPath.AddLines(new PointF[1] { array4[0] });
		pdfPath.AddBezier(array4[1], array4[1], array4[2], array4[3]);
		...
		pdfPath.AddBezier(array5[0], array5[0], array5[1], array5[2]);
		pdfPath.CloseFigure();
	...
	internal PdfPath GetCurvedDownRibbon()
	{
		...
		pdfPath.AddBezier(array[0], array[0], array[1], array[2]);
		...
		pdfPath.AddLines(array3);
		pdfPath.AddBezier(array2[1], array2[1], array2[2], array2[3]);
	...
	internal PdfPath GetVerticalScroll()
	{
		...
		pdfPath.AddLines(new PointF[1] { array[0] });
		pdfPath.AddArc(array[1].X, array[1].Y, dictionary["ch2"] * 2f, dictionary["ch2"] * 2f, 180f, 90f);
		PointF[] array2 = new PointF[1]
		{
			new PointF(_rectBounds.X + dictionary["x7"], _rectBounds.Y)
		};
		pdfPath.AddArc(array2[0].X - dictionary["ch2"], array2[0].Y, dictionary["ch2"] * 2f, dictionary["ch2"] * 2f, 270f, 180f);
		PointF[] array3 = new PointF[2]
		{
			new PointF(_rectBounds.X + dictionary["x6"], _rectBounds.Y + dictionary["ch"]),
			new PointF(_rectBounds.X + dictionary["x6"], _rectBounds.Y + dictionary["y4"])
		};
		pdfPath.AddLines(new PointF[1] { array3[0] });
		pdfPath.AddArc(array3[1].X - dictionary["ch2"] * 2f, array3[1].Y - dictionary["ch2"], dictionary["ch2"] * 2f, dictionary["ch2"] * 2f, 0f, 90f);
		PointF[] array4 = new PointF[1]
		{
			new PointF(_rectBounds.X + dictionary["ch2"], _rectBounds.Bottom)
		};
		pdfPath.AddArc(array4[0].X - dictionary["ch2"], array4[0].Y - dictionary["ch2"] * 2f, dictionary["ch2"] * 2f, dictionary["ch2"] * 2f, 90f, 180f);
		pdfPath.CloseFigure();
		...
		pdfPath.StartFigure();
		pdfPath.AddArc(array5[0].X - dictionary["ch2"], array5[0].Y, dictionary["ch2"] * 2f, dictionary["ch2"] * 2f, 270f, 180f);
		pdfPath.StartFigure();
		pdfPath.AddArc(array5[0].X - dictionary["ch2"] / 2f, array5[0].Y + dictionary["ch2"], dictionary["ch4"] * 2f, dictionary["ch4"] * 2f, 90f, 180f);
		pdfPath.AddLines(new PointF[1]
		{
		...
		pdfPath.StartFigure();
		pdfPath.AddArc(array7[0].X - dictionary["ch2"] / 2f, array7[0].Y, dictionary["ch4"] * 2f, dictionary["ch4"] * 2f, 270f, 180f);
		pdfPath.AddLines(new PointF[1]
		{
		...
		pdfPath.StartFigure();
		pdfPath.AddArc(array8[0].X - dictionary["ch2"], array8[0].Y - dictionary["ch2"] * 2f, dictionary["ch2"] * 2f, dictionary["ch2"] * 2f, 90f, -90f);
		pdfPath.AddLines(new PointF[1]
		{
			new PointF(_rectBounds.X + dictionary["ch"], _rectBounds.Y + dictionary["y3"])
		});
	...
	internal PdfPath GetWave()
	{
		...
		pdfPath.AddBezier(array[0], array[1], array[2], array[3]);
	...
	internal PdfPath GetDoubleWave()
	{
		...
		pdfPath.AddBezier(array[3], array2[1], array2[2], array2[3]);
	...
	internal PdfPath GetRoundedRectangularCalloutPath()
	{
		...
		PdfPath pdfPath = new PdfPath();
		PointF[] array = new PointF[4];
		pdfPath.AddArc(_rectBounds.X, _rectBounds.Y, dictionary["u1"] * 2f, dictionary["u1"] * 2f, 180f, 90f);
		array[0] = new PointF(_rectBounds.X + dictionary["x1"], _rectBounds.Y);
		...
		pdfPath.AddLines(array);
		pdfPath.AddArc(array[3].X - dictionary["u1"], array[3].Y, dictionary["u1"] * 2f, dictionary["u1"] * 2f, 270f, 90f);
		array = new PointF[4]
		{
			new PointF(_rectBounds.Right, _rectBounds.Y + dictionary["y1"]),
			new PointF(_rectBounds.X + dictionary["xr"], _rectBounds.Y + dictionary["yr"]),
		...
		pdfPath.AddLines(array);
		pdfPath.AddArc(array[3].X - dictionary["u1"] * 2f, array[3].Y - dictionary["u1"], dictionary["u1"] * 2f, dictionary["u1"] * 2f, 0f, 90f);
		array = new PointF[4]
		{
			new PointF(_rectBounds.X + dictionary["x2"], _rectBounds.Bottom),
			new PointF(_rectBounds.X + dictionary["xb"], _rectBounds.Y + dictionary["yb"]),
		...
		pdfPath.AddLines(array);
		pdfPath.AddArc(array[3].X - dictionary["u1"], array[3].Y - dictionary["u1"] * 2f, dictionary["u1"] * 2f, dictionary["u1"] * 2f, 90f, 90f);
		pdfPath.AddLines(new PointF[3]
		{
			new PointF(_rectBounds.X, _rectBounds.Y + dictionary["y2"]),
			new PointF(_rectBounds.X + dictionary["xl"], _rectBounds.Y + dictionary["yl"]),
	...
	internal PdfPath GetOvalCalloutPath()
	{
		...
		pdfPath.AddArc(_rectBounds.X, _rectBounds.Y, _rectBounds.Width, _rectBounds.Height, num, num2);
		pdfPath.AddLines(array);
		pdfPath.CloseFigure();
		return pdfPath;
	}
	...
	internal PdfPath GetVMLCustomShapePath(List<DocGen.DocIO.DLS.Path2D> path2DPoints)
	{
		PdfPath pdfPath = new PdfPath();
	...
	private void GetGeomentryPath(PdfPath path, List<double> pathElements, double pathWidth, double pathHeight, RectangleF bounds)
	{
		PointF pointF = Point.Empty;
		double num = 0.0;
		int num2;
		for (num2 = 0; num2 < pathElements.Count; num2++)
		{
			...
			case DocGen.DocIO.DLS.Path2D.Path2DElements.ArcTo:
			{
				...
				rectangle.Width = (float)(pathElements[num2 + 2] / 12700.0) * 2f;
				rectangle.Height = (float)(pathElements[num2 + 3] / 12700.0) * 2f;
	...
	public ShapePath Get(RectangleF bounds, Dictionary<string, string> shapeGuide)
	{
		_shapeGuide = shapeGuide;
		_rectBounds = bounds;
		return this;
