...
internal class ExternCountRecord : BiffRecordRaw
{
	...
	public ushort ExternSheetNumber
	{
		get
		{
			return m_usExternSheetNumber;
		}
		set
		{
			m_usExternSheetNumber = value;
		}
	}
	...
	{
		m_usExternSheetNumber = provider.ReadUInt16(iOffset);
	}

	public override void InfillInternalData(DataProvider provider, int iOffset, OfficeVersion version)
	{
		provider.WriteUInt16(iOffset, m_usExternSheetNumber);
		m_iLength = 2;
	}
