...
{
	private static readonly byte[] m_piTable = new byte[256]
	{
	...
	private int[] GenerateKey(byte[] key, int bits)
	{
		...
		if (num < 128)
		{
			...
			do
			{
				num3 = m_piTable[(num3 + array[num2++]) & 0xFF] & 0xFF;
				array[num++] = num3;
			}
			while (num < 128);
		}
		num = bits + 7 >> 3;
		num3 = (array[128 - num] = m_piTable[array[128 - num] & (255 >> (7 & -bits))] & 0xFF);
		for (int num4 = 128 - num - 1; num4 >= 0; num4--)
		{
			num3 = (array[num4] = m_piTable[num3 ^ array[num4 + num]] & 0xFF);
		}
	...
	{
		m_isEncrypt = forEncryption;
		if (parameters is KeyParameter)
		{
			byte[] keys = ((KeyParameter)parameters).Keys;
			m_Key = GenerateKey(keys, keys.Length * 8);
		}
	}
	...
	private void EncryptBlock(byte[] input, int inOff, byte[] outBytes, int outOff)
	{
		...
		{
			num4 = RotateWordLeft(num4 + (num3 & ~num) + (num2 & num) + m_Key[i], 1);
			num3 = RotateWordLeft(num3 + (num2 & ~num4) + (num & num4) + m_Key[i + 1], 2);
			num2 = RotateWordLeft(num2 + (num & ~num3) + (num4 & num3) + m_Key[i + 2], 3);
			num = RotateWordLeft(num + (num4 & ~num2) + (num3 & num2) + m_Key[i + 3], 5);
		}
		num4 += m_Key[num & 0x3F];
		num3 += m_Key[num4 & 0x3F];
		num2 += m_Key[num3 & 0x3F];
		num += m_Key[num2 & 0x3F];
		for (int j = 20; j <= 40; j += 4)
		{
			num4 = RotateWordLeft(num4 + (num3 & ~num) + (num2 & num) + m_Key[j], 1);
			num3 = RotateWordLeft(num3 + (num2 & ~num4) + (num & num4) + m_Key[j + 1], 2);
			num2 = RotateWordLeft(num2 + (num & ~num3) + (num4 & num3) + m_Key[j + 2], 3);
			num = RotateWordLeft(num + (num4 & ~num2) + (num3 & num2) + m_Key[j + 3], 5);
		}
		num4 += m_Key[num & 0x3F];
		num3 += m_Key[num4 & 0x3F];
		num2 += m_Key[num3 & 0x3F];
		...
		{
			num4 = RotateWordLeft(num4 + (num3 & ~num) + (num2 & num) + m_Key[k], 1);
			num3 = RotateWordLeft(num3 + (num2 & ~num4) + (num & num4) + m_Key[k + 1], 2);
			num2 = RotateWordLeft(num2 + (num & ~num3) + (num4 & num3) + m_Key[k + 2], 3);
			num = RotateWordLeft(num + (num4 & ~num2) + (num3 & num2) + m_Key[k + 3], 5);
		}
	...
	private void DecryptBlock(byte[] input, int inOff, byte[] outBytes, int outOff)
	{
		...
		{
			num = RotateWordLeft(num, 11) - ((num4 & ~num2) + (num3 & num2) + m_Key[num5 + 3]);
			num2 = RotateWordLeft(num2, 13) - ((num & ~num3) + (num4 & num3) + m_Key[num5 + 2]);
			num3 = RotateWordLeft(num3, 14) - ((num2 & ~num4) + (num & num4) + m_Key[num5 + 1]);
			num4 = RotateWordLeft(num4, 15) - ((num3 & ~num) + (num2 & num) + m_Key[num5]);
		}
		num -= m_Key[num2 & 0x3F];
		num2 -= m_Key[num3 & 0x3F];
		num3 -= m_Key[num4 & 0x3F];
		...
		{
			num = RotateWordLeft(num, 11) - ((num4 & ~num2) + (num3 & num2) + m_Key[num6 + 3]);
			num2 = RotateWordLeft(num2, 13) - ((num & ~num3) + (num4 & num3) + m_Key[num6 + 2]);
			num3 = RotateWordLeft(num3, 14) - ((num2 & ~num4) + (num & num4) + m_Key[num6 + 1]);
			num4 = RotateWordLeft(num4, 15) - ((num3 & ~num) + (num2 & num) + m_Key[num6]);
		}
		num -= m_Key[num2 & 0x3F];
		num2 -= m_Key[num3 & 0x3F];
		num3 -= m_Key[num4 & 0x3F];
		...
		{
			num = RotateWordLeft(num, 11) - ((num4 & ~num2) + (num3 & num2) + m_Key[num7 + 3]);
			num2 = RotateWordLeft(num2, 13) - ((num & ~num3) + (num4 & num3) + m_Key[num7 + 2]);
			num3 = RotateWordLeft(num3, 14) - ((num2 & ~num4) + (num & num4) + m_Key[num7 + 1]);
			num4 = RotateWordLeft(num4, 15) - ((num3 & ~num) + (num2 & num) + m_Key[num7]);
		}
		outBytes[outOff] = (byte)num4;
		outBytes[outOff + 1] = (byte)(num4 >> 8);
		outBytes[outOff + 2] = (byte)num3;
