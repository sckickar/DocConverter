...
namespace DocGen.DocIO.Utilities;
...
public abstract class DocIOEncoding
{
	...
	public static string GetString(byte[] bytes)
	{
		...
		{
			int num2 = bytes[i];
			byte[] bytes2 = BitConverter.GetBytes((short)m_charCodeTable[num2]);
			string @string = Encoding.Unicode.GetString(bytes2, 0, bytes2.Length);
